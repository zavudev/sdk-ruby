...
module Zavudev
  module Resources
    class PhoneNumbers
      ...
      # {Zavudev::Models::PhoneNumberUpdateParams} for more details.
      #
      ...
      #
      # @param sender_id [String, nil] Sender ID to assign the phone number to. Set to null to unassign. A number under
      #
      # @param request_options [Zavudev::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      ...
      #
      # @overload purchase(phone_number:, name: nil, regulatory_requirements: nil, type: nil, request_options: {})
      #
      ...
      #
      # @overload requirements(country_code: nil, phone_number: nil, type: nil, request_options: {})
      #
      ...
      def requirements(params = {})
        ...
        @client.request(
          ...
          query: query.transform_keys(country_code: "countryCode", phone_number: "phoneNumber"),
