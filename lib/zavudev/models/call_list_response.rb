...
module Zavudev
  module Models
    ...
    class CallListResponse < Zavudev::Internal::Type::BaseModel
      # @!attribute id
      #
      #   @return [String]
      required :id, String
      ...
      #   (inbound).
      #
      #   @return [Symbol, Zavudev::Models::CallListResponse::Direction]
      ...
      #
      #   @return [Symbol, Zavudev::Models::CallListResponse::Status]
      ...
      #   from list responses.
      #
      #   @return [Array<Zavudev::Models::CallListResponse::Transcript>, nil]
      optional :transcript,
      ...
      #   {Zavudev::Models::CallListResponse} for more details.
      #
      #   @param id [String]
      #
      #   @param created_at [Time]
      #
      #   @param direction [Symbol, Zavudev::Models::CallListResponse::Direction] Whether the call was placed by Zavu (outbound) or received from a caller (inboun
      #
      #   @param from [String] Caller phone number in E.164 format. Your sender's number for outbound calls; th
      #
      #   @param status [Symbol, Zavudev::Models::CallListResponse::Status] Lifecycle status of a voice call.
      #
      ...
      #
      #   @param transcript [Array<Zavudev::Models::CallListResponse::Transcript>] Ordered transcript of the call. Included when retrieving a single call; omitted
      #
      ...
      # (inbound).
      #
      # @see Zavudev::Models::CallListResponse#direction
      module Direction
      ...
      # - `canceled`: canceled before it was answered.
      #
      # @see Zavudev::Models::CallListResponse#status
      module Status
        extend Zavudev::Internal::Type::Enum
      ...
      class Transcript < Zavudev::Internal::Type::BaseModel
        ...
        #   conversation.
        #
        #   @return [Symbol, Zavudev::Models::CallListResponse::Transcript::Role]
        required :role, enum: -> { Zavudev::Models::CallListResponse::Transcript::Role }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Zavudev::Models::CallListResponse::Transcript} for more details.
        #
        #   A single turn in a voice call transcript.
        #
        #   @param role [Symbol, Zavudev::Models::CallListResponse::Transcript::Role] Who produced the turn. `tool` records a tool call the agent made during the conv
        #
        ...
        # conversation.
        #
        # @see Zavudev::Models::CallListResponse::Transcript#role
        module Role
          extend Zavudev::Internal::Type::Enum
