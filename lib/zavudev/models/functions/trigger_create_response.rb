  ...
  module Models
    module Functions
      ...
      class TriggerCreateResponse < Zavudev::Internal::Type::BaseModel
        ...
        # @!attribute triggers
        #
        #   @return [Array<Zavudev::Models::Functions::TriggerCreateResponse::Trigger>]
        required :triggers,
                 -> { Zavudev::Internal::Type::ArrayOf[Zavudev::Models::Functions::TriggerCreateResponse::Trigger] }

        # @!method initialize(added:, skipped:, triggers:)
        #   @param added [Integer]
        #
        #   @param skipped [Integer] Number of triggers that already existed.
        #
        #   @param triggers [Array<Zavudev::Models::Functions::TriggerCreateResponse::Trigger>]
        ...
        class Trigger < Zavudev::Internal::Type::BaseModel
          ...
          #   {Zavudev::Models::Functions::TriggerCreateResponse::Trigger} for more details.
          #
