  ...
  module Models
    module Functions
      ...
      class GitLinkUpdateResponse < Zavudev::Internal::Type::BaseModel
        ...
        #
        #   @return [Zavudev::Models::Functions::GitLinkUpdateResponse::Link]
        required :link, -> { Zavudev::Models::Functions::GitLinkUpdateResponse::Link }
        ...
        #   {Zavudev::Models::Functions::GitLinkUpdateResponse} for more details.
        #
        #   @param link [Zavudev::Models::Functions::GitLinkUpdateResponse::Link] A GitHub repository bound to a function. A push to `branch` deploys the function
        #
        ...
        # @see Zavudev::Models::Functions::GitLinkUpdateResponse#link
        class Link < Zavudev::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Zavudev::Models::Functions::GitLinkUpdateResponse::Link::Connection]
          required :connection, enum: -> { Zavudev::Models::Functions::GitLinkUpdateResponse::Link::Connection }
          ...
          # @!attribute provider
          #
          #   @return [Symbol, Zavudev::Models::Functions::GitLinkUpdateResponse::Link::Provider]
          required :provider, enum: -> { Zavudev::Models::Functions::GitLinkUpdateResponse::Link::Provider }
          ...
          #
          #   @return [Symbol, Zavudev::Models::Functions::GitLinkUpdateResponse::Link::LastStatus, nil]
          optional :last_status,
                   enum: -> { Zavudev::Models::Functions::GitLinkUpdateResponse::Link::LastStatus },
                   api_name: :lastStatus,
                   nil?: true
          ...
          #   Some parameter documentations has been truncated, see
          #   {Zavudev::Models::Functions::GitLinkUpdateResponse::Link} for more details.
          #
          #   A GitHub repository bound to a function. A push to `branch` deploys the
          #   function. A function holds at most one link.
          #
          ...
          #
          #   @param connection [Symbol, Zavudev::Models::Functions::GitLinkUpdateResponse::Link::Connection] How this link authenticates, decided by the server rather than by the caller.
          #
          ...
          #   @param owner [String]
          #
          #   @param provider [Symbol, Zavudev::Models::Functions::GitLinkUpdateResponse::Link::Provider]
          #
          #   @param repo [String]
          #
          ...
          #
          #   @param last_status [Symbol, Zavudev::Models::Functions::GitLinkUpdateResponse::Link::LastStatus, nil]
          #
          ...
          #   webhook to the repository yourself.
          #
          # @see Zavudev::Models::Functions::GitLinkUpdateResponse::Link#connection
          module Connection
          ...
          # @see Zavudev::Models::Functions::GitLinkUpdateResponse::Link#provider
          module Provider
            extend Zavudev::Internal::Type::Enum
          ...
          # @see Zavudev::Models::Functions::GitLinkUpdateResponse::Link#last_status
          module LastStatus
            extend Zavudev::Internal::Type::Enum
