...
module Zavudev
  module Models
    module Functions
      # @see Zavudev::Resources::Functions::GitLink#retrieve
      class GitLinkRetrieveResponse < Zavudev::Internal::Type::BaseModel
        # @!attribute link
        #   A GitHub repository bound to a function. A push to `branch` deploys the
        #   function. A function holds at most one link.
        #
        #   @return [Zavudev::Models::Functions::GitLinkRetrieveResponse::Link]
        ...
        #   {Zavudev::Models::Functions::GitLinkRetrieveResponse} for more details.
        #
        #   @param link [Zavudev::Models::Functions::GitLinkRetrieveResponse::Link] A GitHub repository bound to a function. A push to `branch` deploys the function
        #
        ...
        # @see Zavudev::Models::Functions::GitLinkRetrieveResponse#link
        class Link < Zavudev::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::Connection]
          required :connection, enum: -> { Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::Connection }
          ...
          # @!attribute provider
          #
          #   @return [Symbol, Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::Provider]
          required :provider, enum: -> { Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::Provider }
          ...
          #
          #   @return [Symbol, Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::LastStatus, nil]
          optional :last_status,
                   enum: -> { Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::LastStatus },
                   api_name: :lastStatus,
                   nil?: true
          ...
          #   Some parameter documentations has been truncated, see
          #   {Zavudev::Models::Functions::GitLinkRetrieveResponse::Link} for more details.
          #
          #   A GitHub repository bound to a function. A push to `branch` deploys the
          #   function. A function holds at most one link.
          #
          ...
          #
          #   @param connection [Symbol, Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::Connection] How this link authenticates, decided by the server rather than by the caller.
          #
          ...
          #   @param owner [String]
          #
          #   @param provider [Symbol, Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::Provider]
          #
          #   @param repo [String]
          #
          ...
          #
          #   @param last_status [Symbol, Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::LastStatus, nil]
          #
          ...
          #   webhook to the repository yourself.
          #
          # @see Zavudev::Models::Functions::GitLinkRetrieveResponse::Link#connection
          module Connection
          ...
          # @see Zavudev::Models::Functions::GitLinkRetrieveResponse::Link#provider
          module Provider
            extend Zavudev::Internal::Type::Enum
          ...
          # @see Zavudev::Models::Functions::GitLinkRetrieveResponse::Link#last_status
          module LastStatus
            extend Zavudev::Internal::Type::Enum
