...
module Zavudev
  module Models
    ...
    class ConversationMarkAsReadResponse < Zavudev::Internal::Type::BaseModel
      ...
      #
      #   @return [Zavudev::Models::ConversationMarkAsReadResponse::Conversation]
      required :conversation, -> { Zavudev::Models::ConversationMarkAsReadResponse::Conversation }

      # @!method initialize(conversation:)
      #   Some parameter documentations has been truncated, see
      #   {Zavudev::Models::ConversationMarkAsReadResponse} for more details.
      #
      #   @param conversation [Zavudev::Models::ConversationMarkAsReadResponse::Conversation] An inbox thread with one contact. A conversation groups every message exchanged

      # @see Zavudev::Models::ConversationMarkAsReadResponse#conversation
      class Conversation < Zavudev::Internal::Type::BaseModel
        ...
        #   fetch.
        #
        #   @return [Zavudev::Models::ConversationMarkAsReadResponse::Conversation::LastMessage]
        ...
        #
        #   @return [Zavudev::Models::ConversationMarkAsReadResponse::Conversation::Group, nil]
        optional :group, -> { Zavudev::Models::ConversationMarkAsReadResponse::Conversation::Group }
        ...
        #
        #   @return [Zavudev::Models::ConversationMarkAsReadResponse::Conversation::Whatsapp, nil]
        optional :whatsapp, -> { Zavudev::Models::ConversationMarkAsReadResponse::Conversation::Whatsapp }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Zavudev::Models::ConversationMarkAsReadResponse::Conversation} for more
        #   details.
        #
        #   An inbox thread with one contact. A conversation groups every message exchanged
        #   with that contact across channels, so a contact who writes on WhatsApp and later
        ...
        #
        #   @param last_message [Zavudev::Models::ConversationMarkAsReadResponse::Conversation::LastMessage] Denormalized preview of the most recent message, so a thread list needs no extra
        #
        ...
        #
        #   @param group [Zavudev::Models::ConversationMarkAsReadResponse::Conversation::Group] Present when the thread is a group chat rather than a one-to-one conversation.
        #
        #   @param sender_id [String] Sender that last handled this thread. Use it as the `Zavu-Sender` header when re
        #
        #   @param whatsapp [Zavudev::Models::ConversationMarkAsReadResponse::Conversation::Whatsapp] WhatsApp identity, present when the contact adopted a username.

        # @see Zavudev::Models::ConversationMarkAsReadResponse::Conversation#last_message
        class LastMessage < Zavudev::Internal::Type::BaseModel
          ...
          # @!attribute direction
          #
          #   @return [Symbol, Zavudev::Models::ConversationMarkAsReadResponse::Conversation::LastMessage::Direction]
          required :direction,
                   enum: -> { Zavudev::Models::ConversationMarkAsReadResponse::Conversation::LastMessage::Direction }
          ...
          #
          #   @param direction [Symbol, Zavudev::Models::ConversationMarkAsReadResponse::Conversation::LastMessage::Direction]
          #
          #   @param text [String] Text or caption. Empty when the last message carried no text (e.g. media).

          # @see Zavudev::Models::ConversationMarkAsReadResponse::Conversation::LastMessage#direction
          module Direction
        ...
        # @see Zavudev::Models::ConversationMarkAsReadResponse::Conversation#group
        ...
        # @see Zavudev::Models::ConversationMarkAsReadResponse::Conversation#whatsapp
