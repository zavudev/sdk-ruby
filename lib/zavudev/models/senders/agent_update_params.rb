  ...
  module Models
    module Senders
      ...
      class AgentUpdateParams < Zavudev::Internal::Type::BaseModel
        ...
        #   for your team.
        #
        #   @return [Zavudev::Models::Senders::AgentUpdateParams::Voice, nil]
        optional :voice, -> { Zavudev::Senders::AgentUpdateParams::Voice }

        # @!method initialize(sender_id:, api_key: nil, context_window_messages: nil, enabled: nil, include_contact_metadata: nil, max_tokens: nil, model: nil, name: nil, provider: nil, system_prompt: nil, temperature: nil, trigger_on_channels: nil, trigger_on_message_types: nil, voice: nil, request_options: {})
        ...
        class Voice < Zavudev::Internal::Type::BaseModel
          ...
          #   outbound call.
          #
          #   @return [Symbol, Zavudev::Models::Senders::AgentUpdateParams::Voice::VoicemailAction, nil]
          optional :voicemail_action,
                   enum: -> { Zavudev::Senders::AgentUpdateParams::Voice::VoicemailAction },
          ...
          #   Some parameter documentations has been truncated, see
          #   {Zavudev::Models::Senders::AgentUpdateParams::Voice} for more details.
          #
          #   Voice Agent configuration. Patch this object to enable voice, change the
          #   greeting, or adjust call limits. Requires the Voice Agents feature to be enabled
          #   for your team.
          ...
          #
          #   @param voicemail_action [Symbol, Zavudev::Models::Senders::AgentUpdateParams::Voice::VoicemailAction] What the agent does when an answering machine or voicemail is detected on an out
          #
          ...
          # outbound call.
          #
          # @see Zavudev::Models::Senders::AgentUpdateParams::Voice#voicemail_action
