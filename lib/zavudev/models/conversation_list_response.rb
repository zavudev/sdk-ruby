...
module Zavudev
  module Models
    ...
    class ConversationListResponse < Zavudev::Internal::Type::BaseModel
      ...
      #   fetch.
      #
      #   @return [Zavudev::Models::ConversationListResponse::LastMessage]
      ...
      #
      #   @return [Zavudev::Models::ConversationListResponse::Group, nil]
      ...
      #
      #   @return [Zavudev::Models::ConversationListResponse::Whatsapp, nil]
      ...
      #   {Zavudev::Models::ConversationListResponse} for more details.
      #
      ...
      #
      #   @param last_message [Zavudev::Models::ConversationListResponse::LastMessage] Denormalized preview of the most recent message, so a thread list needs no extra
      #
      ...
      #
      #   @param group [Zavudev::Models::ConversationListResponse::Group] Present when the thread is a group chat rather than a one-to-one conversation.
      #
      #   @param sender_id [String] Sender that last handled this thread. Use it as the `Zavu-Sender` header when re
      #
      #   @param whatsapp [Zavudev::Models::ConversationListResponse::Whatsapp] WhatsApp identity, present when the contact adopted a username.

      # @see Zavudev::Models::ConversationListResponse#last_message
      class LastMessage < Zavudev::Internal::Type::BaseModel
        ...
        # @!attribute direction
        #
        #   @return [Symbol, Zavudev::Models::ConversationListResponse::LastMessage::Direction]
        ...
        #
        #   @param direction [Symbol, Zavudev::Models::ConversationListResponse::LastMessage::Direction]
        #
        #   @param text [String] Text or caption. Empty when the last message carried no text (e.g. media).

        # @see Zavudev::Models::ConversationListResponse::LastMessage#direction
        module Direction
      ...
      # @see Zavudev::Models::ConversationListResponse#group
      ...
      # @see Zavudev::Models::ConversationListResponse#whatsapp
