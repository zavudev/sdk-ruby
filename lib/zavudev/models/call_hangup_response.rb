...
module Zavudev
  module Models
    ...
    class CallHangupResponse < Zavudev::Internal::Type::BaseModel
      # @!attribute call
      #
      #   @return [Zavudev::Models::CallHangupResponse::Call]
      required :call, -> { Zavudev::Models::CallHangupResponse::Call }

      # @!method initialize(call:)
      #   @param call [Zavudev::Models::CallHangupResponse::Call]

      # @see Zavudev::Models::CallHangupResponse#call
      class Call < Zavudev::Internal::Type::BaseModel
        ...
        #   (inbound).
        #
        #   @return [Symbol, Zavudev::Models::CallHangupResponse::Call::Direction]
        required :direction, enum: -> { Zavudev::Models::CallHangupResponse::Call::Direction }
        ...
        #
        #   @return [Symbol, Zavudev::Models::CallHangupResponse::Call::Status]
        required :status, enum: -> { Zavudev::Models::CallHangupResponse::Call::Status }
        ...
        #   from list responses.
        #
        #   @return [Array<Zavudev::Models::CallHangupResponse::Call::Transcript>, nil]
        optional :transcript,
                 -> { Zavudev::Internal::Type::ArrayOf[Zavudev::Models::CallHangupResponse::Call::Transcript] }
        ...
        #   {Zavudev::Models::CallHangupResponse::Call} for more details.
        #
        #   @param id [String]
        #
        #   @param created_at [Time]
        #
        #   @param direction [Symbol, Zavudev::Models::CallHangupResponse::Call::Direction] Whether the call was placed by Zavu (outbound) or received from a caller (inboun
        #
        #   @param from [String] Caller phone number in E.164 format. Your sender's number for outbound calls; th
        #
        #   @param status [Symbol, Zavudev::Models::CallHangupResponse::Call::Status] Lifecycle status of a voice call.
        #
        ...
        #
        #   @param transcript [Array<Zavudev::Models::CallHangupResponse::Call::Transcript>] Ordered transcript of the call. Included when retrieving a single call; omitted
        #
        ...
        # (inbound).
        #
        # @see Zavudev::Models::CallHangupResponse::Call#direction
        module Direction
        ...
        # - `canceled`: canceled before it was answered.
        #
        # @see Zavudev::Models::CallHangupResponse::Call#status
        module Status
          extend Zavudev::Internal::Type::Enum
        ...
        class Transcript < Zavudev::Internal::Type::BaseModel
          ...
          #   conversation.
          #
          #   @return [Symbol, Zavudev::Models::CallHangupResponse::Call::Transcript::Role]
          required :role, enum: -> { Zavudev::Models::CallHangupResponse::Call::Transcript::Role }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Zavudev::Models::CallHangupResponse::Call::Transcript} for more details.
          #
          #   A single turn in a voice call transcript.
          #
          #   @param role [Symbol, Zavudev::Models::CallHangupResponse::Call::Transcript::Role] Who produced the turn. `tool` records a tool call the agent made during the conv
          #
          ...
          # conversation.
          #
          # @see Zavudev::Models::CallHangupResponse::Call::Transcript#role
          module Role
            extend Zavudev::Internal::Type::Enum
