...
module Zavudev
  module Models
    ...
    class AgentCreateParams < Zavudev::Internal::Type::BaseModel
      ...
      #   team.
      #
      #   @return [Zavudev::Models::AgentCreateParams::Voice, nil]
      optional :voice, -> { Zavudev::AgentCreateParams::Voice }

      # @!method initialize(model:, name:, provider:, system_prompt:, context_window_messages: nil, include_contact_metadata: nil, max_tokens: nil, temperature: nil, trigger_on_channels: nil, trigger_on_message_types: nil, voice: nil, request_options: {})
      ...
      class Voice < Zavudev::Internal::Type::BaseModel
        ...
        #   outbound call.
        #
        #   @return [Symbol, Zavudev::Models::AgentCreateParams::Voice::VoicemailAction, nil]
        optional :voicemail_action,
                 enum: -> { Zavudev::AgentCreateParams::Voice::VoicemailAction },
        ...
        #   Some parameter documentations has been truncated, see
        #   {Zavudev::Models::AgentCreateParams::Voice} for more details.
        #
        #   Voice Agent configuration on a sender's AI agent. Controls how the agent behaves
        #   on inbound and outbound phone calls through Zavu's managed voice pipeline
        #   (speech recognition, the agent's LLM, and speech synthesis, with real-time
        ...
        #
        #   @param voicemail_action [Symbol, Zavudev::Models::AgentCreateParams::Voice::VoicemailAction] What the agent does when an answering machine or voicemail is detected on an out
        #
        ...
        # outbound call.
        #
        # @see Zavudev::Models::AgentCreateParams::Voice#voicemail_action
