...
module Zavudev
  module Models
    ...
    class CallCreateResponse < Zavudev::Internal::Type::BaseModel
      # @!attribute call
      #
      #   @return [Zavudev::Models::CallCreateResponse::Call]
      required :call, -> { Zavudev::Models::CallCreateResponse::Call }

      # @!method initialize(call:)
      #   @param call [Zavudev::Models::CallCreateResponse::Call]

      # @see Zavudev::Models::CallCreateResponse#call
      class Call < Zavudev::Internal::Type::BaseModel
        ...
        #   (inbound).
        #
        #   @return [Symbol, Zavudev::Models::CallCreateResponse::Call::Direction]
        required :direction, enum: -> { Zavudev::Models::CallCreateResponse::Call::Direction }
        ...
        #
        #   @return [Symbol, Zavudev::Models::CallCreateResponse::Call::Status]
        required :status, enum: -> { Zavudev::Models::CallCreateResponse::Call::Status }
        ...
        #   from list responses.
        #
        #   @return [Array<Zavudev::Models::CallCreateResponse::Call::Transcript>, nil]
        optional :transcript,
                 -> { Zavudev::Internal::Type::ArrayOf[Zavudev::Models::CallCreateResponse::Call::Transcript] }
        ...
        #   {Zavudev::Models::CallCreateResponse::Call} for more details.
        #
        #   @param id [String]
        #
        #   @param created_at [Time]
        #
        #   @param direction [Symbol, Zavudev::Models::CallCreateResponse::Call::Direction] Whether the call was placed by Zavu (outbound) or received from a caller (inboun
        #
        #   @param from [String] Caller phone number in E.164 format. Your sender's number for outbound calls; th
        #
        #   @param status [Symbol, Zavudev::Models::CallCreateResponse::Call::Status] Lifecycle status of a voice call.
        #
        ...
        #
        #   @param transcript [Array<Zavudev::Models::CallCreateResponse::Call::Transcript>] Ordered transcript of the call. Included when retrieving a single call; omitted
        #
        ...
        # (inbound).
        #
        # @see Zavudev::Models::CallCreateResponse::Call#direction
        module Direction
        ...
        # - `canceled`: canceled before it was answered.
        #
        # @see Zavudev::Models::CallCreateResponse::Call#status
        module Status
          extend Zavudev::Internal::Type::Enum
        ...
        class Transcript < Zavudev::Internal::Type::BaseModel
          ...
          #   conversation.
          #
          #   @return [Symbol, Zavudev::Models::CallCreateResponse::Call::Transcript::Role]
          required :role, enum: -> { Zavudev::Models::CallCreateResponse::Call::Transcript::Role }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Zavudev::Models::CallCreateResponse::Call::Transcript} for more details.
          #
          #   A single turn in a voice call transcript.
          #
          #   @param role [Symbol, Zavudev::Models::CallCreateResponse::Call::Transcript::Role] Who produced the turn. `tool` records a tool call the agent made during the conv
          #
          ...
          # conversation.
          #
          # @see Zavudev::Models::CallCreateResponse::Call::Transcript#role
          module Role
            extend Zavudev::Internal::Type::Enum
