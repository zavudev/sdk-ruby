    ...
    module Util
      ...
      class << self
        ...
        def coerce_hash!(input)
          ...
          in Hash | nil => coerced
            ...
            message = "Expected a #{Hash} or #{Zavudev::Internal::Type::BaseModel}, got #{data.inspect}"
      ...
      class << self
        ...
        def encode_content(headers, body)
          ...
          in [Zavudev::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [Zavudev::Internal::Util::JSONL_CONTENT, Enumerable] unless Zavudev::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | Zavudev::Internal::Type::FileInput]
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in Zavudev::Internal::Util::JSON_CONTENT
          ...
          in Zavudev::Internal::Util::JSONL_CONTENT
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [Zavudev::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in Zavudev::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
