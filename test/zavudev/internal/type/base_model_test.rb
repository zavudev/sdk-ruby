...
class Zavudev::Test::PrimitiveModelTest < Minitest::Test
  A = Zavudev::Internal::Type::ArrayOf[-> { Integer }]
  H = Zavudev::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend Zavudev::Internal::Type::Union
  end

  class B < Zavudev::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Zavudev::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Zavudev::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Zavudev::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Zavudev::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Zavudev::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Zavudev::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Zavudev::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Zavudev::Internal::Type::Boolean, true] => true,
      [Zavudev::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Zavudev::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Zavudev::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Zavudev::Internal::Type::Converter.new_coerce_state
      Zavudev::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Zavudev::Internal::Type::Converter.dump(target, input, state: state)
...
class Zavudev::Test::EnumModelTest < Minitest::Test
  class E0
    include Zavudev::Internal::Type::Enum
...
class Zavudev::Test::CollectionModelTest < Minitest::Test
  A1 = Zavudev::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Zavudev::Internal::Type::HashOf[Integer]

  A2 = Zavudev::Internal::Type::ArrayOf[H1]
  H2 = Zavudev::Internal::Type::HashOf[-> { A1 }]

  A3 = Zavudev::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Zavudev::Internal::Type::HashOf[Integer, nil?: true]
...
class Zavudev::Test::BaseModelTest < Minitest::Test
  class M1 < Zavudev::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Zavudev::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Zavudev::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Zavudev::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Zavudev::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Zavudev::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Zavudev::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Zavudev::Errors::ConversionError => e
...
class Zavudev::Test::UnionTest < Minitest::Test
  class U0
    include Zavudev::Internal::Type::Union
  ...
  class M2 < Zavudev::Internal::Type::BaseModel
  ...
  class M4 < Zavudev::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Zavudev::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Zavudev::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Zavudev::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Zavudev::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Zavudev::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Zavudev::Internal::Type::Unknown, Zavudev::Internal::Type::Unknown] => true,
      [Zavudev::Internal::Type::Boolean, Zavudev::Internal::Type::Boolean] => true,
      [Zavudev::Internal::Type::Unknown, Zavudev::Internal::Type::Boolean] => false,
...
class Zavudev::Test::MetaInfoTest < Minitest::Test
  A1 = Zavudev::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Zavudev::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
