  ...
  module Models
    class ConversationRetrieveResponse < Zavudev::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Zavudev::Models::ConversationRetrieveResponse,
      ...
      sig do
        returns(Zavudev::Models::ConversationRetrieveResponse::Conversation)
      end
      ...
      sig do
        params(
          conversation:
            Zavudev::Models::ConversationRetrieveResponse::Conversation::OrHash
        ).void
      end
      ...
      class Conversation < Zavudev::Internal::Type::BaseModel
        ...
        sig do
          params(
            last_message:
              Zavudev::Models::ConversationRetrieveResponse::Conversation::LastMessage::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Zavudev::Models::ConversationRetrieveResponse::Conversation::Group
            )
          )
        end
        attr_reader :group
        ...
        sig do
          params(
            group:
              Zavudev::Models::ConversationRetrieveResponse::Conversation::Group::OrHash
          ).void
        end
        attr_writer :group
        ...
        sig do
          returns(
            T.nilable(
              Zavudev::Models::ConversationRetrieveResponse::Conversation::Whatsapp
            )
          )
        end
        ...
        sig do
          params(
            whatsapp:
              Zavudev::Models::ConversationRetrieveResponse::Conversation::Whatsapp::OrHash
          ).void
        end
        ...
        class LastMessage < Zavudev::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Zavudev::Models::ConversationRetrieveResponse::Conversation::LastMessage::Direction::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              direction:
                Zavudev::Models::ConversationRetrieveResponse::Conversation::LastMessage::Direction::OrSymbol,
              text: String
            ).returns(T.attached_class)
          end
          def self.new(
