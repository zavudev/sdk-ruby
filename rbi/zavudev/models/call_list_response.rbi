...
module Zavudev
  module Models
    class CallListResponse < Zavudev::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Zavudev::Models::CallListResponse, Zavudev::Internal::AnyHash)
        end
      ...
      # (inbound).
      sig do
        returns(Zavudev::Models::CallListResponse::Direction::TaggedSymbol)
      end
      ...
      sig { returns(Zavudev::Models::CallListResponse::Status::TaggedSymbol) }
      ...
      sig do
        returns(
          T.nilable(T::Array[Zavudev::Models::CallListResponse::Transcript])
        )
      end
      ...
      sig do
        params(
          transcript:
            T::Array[Zavudev::Models::CallListResponse::Transcript::OrHash]
        ).void
      end
      ...
      sig do
        params(
          id: String,
          created_at: Time,
          direction: Zavudev::Models::CallListResponse::Direction::OrSymbol,
          from: String,
          status: Zavudev::Models::CallListResponse::Status::OrSymbol,
          to: String,
        ...
        override.returns(
          {
            ...
            created_at: Time,
            direction:
              Zavudev::Models::CallListResponse::Direction::TaggedSymbol,
            from: String,
            status: Zavudev::Models::CallListResponse::Status::TaggedSymbol,
            to: String,
            answered_at: T.nilable(Time),
            cost: T.nilable(Float),
            duration_seconds: T.nilable(Integer),
            ...
            end_reason: T.nilable(String),
            metadata: T::Hash[Symbol, String],
            transcript: T::Array[Zavudev::Models::CallListResponse::Transcript],
            turn_count: T.nilable(Integer),
            updated_at: Time
          }
        )
      ...
      module Direction
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Zavudev::Models::CallListResponse::Direction)
          end
        ...
        sig do
          override.returns(
            T::Array[Zavudev::Models::CallListResponse::Direction::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Zavudev::Models::CallListResponse::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        QUEUED =
          T.let(
            :queued,
            Zavudev::Models::CallListResponse::Status::TaggedSymbol
          )
        RINGING =
          T.let(
            :ringing,
        ...
        BUSY =
          T.let(:busy, Zavudev::Models::CallListResponse::Status::TaggedSymbol)
        NO_ANSWER =
          T.let(
            :no_answer,
            Zavudev::Models::CallListResponse::Status::TaggedSymbol
        ...
        sig do
          override.returns(
            T::Array[Zavudev::Models::CallListResponse::Status::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      class Transcript < Zavudev::Internal::Type::BaseModel
        ...
        sig do
          params(
            role: Zavudev::Models::CallListResponse::Transcript::Role::OrSymbol,
            seq: Integer,
            text: String,
            ended_at: T.nilable(Time),
        ...
        module Role
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Zavudev::Models::CallListResponse::Transcript::Role)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
