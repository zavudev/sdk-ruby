...
module Zavudev
  module Models
    class AgentUpdateParams < Zavudev::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Zavudev::AgentUpdateParams, Zavudev::Internal::AnyHash)
        end
      ...
      # for your team.
      sig { returns(T.nilable(Zavudev::AgentUpdateParams::Voice)) }
      attr_reader :voice

      sig { params(voice: Zavudev::AgentUpdateParams::Voice::OrHash).void }
      attr_writer :voice
        ...
        override.returns(
          {
            ...
            trigger_on_channels: T::Array[String],
            trigger_on_message_types: T::Array[String],
            voice: Zavudev::AgentUpdateParams::Voice,
      ...
      class Voice < Zavudev::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Zavudev::AgentUpdateParams::Voice, Zavudev::Internal::AnyHash)
          end
        ...
        sig do
          returns(
            T.nilable(
              Zavudev::AgentUpdateParams::Voice::VoicemailAction::OrSymbol
            )
          )
        end
        ...
        module VoicemailAction
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Zavudev::AgentUpdateParams::Voice::VoicemailAction)
            end
          ...
          HANGUP =
            T.let(
              :hangup,
              Zavudev::AgentUpdateParams::Voice::VoicemailAction::TaggedSymbol
            )
          LEAVE_MESSAGE =
            T.let(
              :leave_message,
