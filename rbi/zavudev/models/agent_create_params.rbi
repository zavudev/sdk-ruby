...
module Zavudev
  module Models
    class AgentCreateParams < Zavudev::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Zavudev::AgentCreateParams, Zavudev::Internal::AnyHash)
        end
      ...
      # team.
      sig { returns(T.nilable(Zavudev::AgentCreateParams::Voice)) }
      attr_reader :voice

      sig { params(voice: Zavudev::AgentCreateParams::Voice::OrHash).void }
      attr_writer :voice
        ...
        override.returns(
          {
            ...
            trigger_on_channels: T::Array[String],
            trigger_on_message_types: T::Array[String],
            voice: Zavudev::AgentCreateParams::Voice,
      ...
      class Voice < Zavudev::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Zavudev::AgentCreateParams::Voice, Zavudev::Internal::AnyHash)
          end
        ...
        sig do
          returns(
            T.nilable(
              Zavudev::AgentCreateParams::Voice::VoicemailAction::OrSymbol
            )
          )
        end
        ...
        module VoicemailAction
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Zavudev::AgentCreateParams::Voice::VoicemailAction)
            end
          ...
          HANGUP =
            T.let(
              :hangup,
              Zavudev::AgentCreateParams::Voice::VoicemailAction::TaggedSymbol
            )
          LEAVE_MESSAGE =
            T.let(
              :leave_message,
