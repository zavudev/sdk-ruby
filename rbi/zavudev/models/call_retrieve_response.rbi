  ...
  module Models
    class CallRetrieveResponse < Zavudev::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Zavudev::Models::CallRetrieveResponse,
            Zavudev::Internal::AnyHash
          )
        end

      sig { returns(Zavudev::Models::CallRetrieveResponse::Call) }
      attr_reader :call

      sig do
        params(call: Zavudev::Models::CallRetrieveResponse::Call::OrHash).void
      end
      attr_writer :call

      sig do
        params(
          call: Zavudev::Models::CallRetrieveResponse::Call::OrHash
      ...
      sig do
        override.returns({ call: Zavudev::Models::CallRetrieveResponse::Call })
      end
      def to_hash
      end
      ...
      class Call < Zavudev::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Zavudev::Models::CallRetrieveResponse::Call::Direction::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            Zavudev::Models::CallRetrieveResponse::Call::Status::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Zavudev::Models::CallRetrieveResponse::Call::Transcript]
            )
          )
        end
        ...
        sig do
          params(
            transcript:
              T::Array[
                Zavudev::Models::CallRetrieveResponse::Call::Transcript::OrHash
              ]
          ).void
        end
        ...
        sig do
          params(
            ...
            created_at: Time,
            direction:
              Zavudev::Models::CallRetrieveResponse::Call::Direction::OrSymbol,
            from: String,
            status:
              Zavudev::Models::CallRetrieveResponse::Call::Status::OrSymbol,
            to: String,
          ...
          override.returns(
            {
              ...
              transcript:
                T::Array[
                  Zavudev::Models::CallRetrieveResponse::Call::Transcript
                ],
              turn_count: T.nilable(Integer),
              updated_at: Time
            }
        ...
        module Direction
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Zavudev::Models::CallRetrieveResponse::Call::Direction
              )
            end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Zavudev::Models::CallRetrieveResponse::Call::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Transcript < Zavudev::Internal::Type::BaseModel
          ...
          sig do
            params(
              role:
                Zavudev::Models::CallRetrieveResponse::Call::Transcript::Role::OrSymbol,
              seq: Integer,
              text: String,
              ended_at: T.nilable(Time),
          ...
          module Role
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Zavudev::Models::CallRetrieveResponse::Call::Transcript::Role
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
