  ...
  module Models
    module Senders
      class AgentCreateParams < Zavudev::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(Zavudev::Senders::AgentCreateParams::Voice)) }
        attr_reader :voice

        sig do
          params(voice: Zavudev::Senders::AgentCreateParams::Voice::OrHash).void
        end
        attr_writer :voice
          ...
          override.returns(
            {
              ...
              trigger_on_channels: T::Array[String],
              trigger_on_message_types: T::Array[String],
              voice: Zavudev::Senders::AgentCreateParams::Voice,
        ...
        class Voice < Zavudev::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Zavudev::Senders::AgentCreateParams::Voice,
                Zavudev::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Zavudev::Senders::AgentCreateParams::Voice::VoicemailAction::OrSymbol
              )
            )
          end
          ...
          module VoicemailAction
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Zavudev::Senders::AgentCreateParams::Voice::VoicemailAction
                )
              end
            ...
            HANGUP =
              T.let(
                :hangup,
                Zavudev::Senders::AgentCreateParams::Voice::VoicemailAction::TaggedSymbol
              )
            LEAVE_MESSAGE =
              T.let(
                :leave_message,
