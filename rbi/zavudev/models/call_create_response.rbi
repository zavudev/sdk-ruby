...
module Zavudev
  module Models
    class CallCreateResponse < Zavudev::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Zavudev::Models::CallCreateResponse, Zavudev::Internal::AnyHash)
        end

      sig { returns(Zavudev::Models::CallCreateResponse::Call) }
      attr_reader :call

      sig do
        params(call: Zavudev::Models::CallCreateResponse::Call::OrHash).void
      end
      attr_writer :call

      sig do
        params(call: Zavudev::Models::CallCreateResponse::Call::OrHash).returns(
          T.attached_class
        )
      end
      def self.new(call:)
      ...
      sig do
        override.returns({ call: Zavudev::Models::CallCreateResponse::Call })
      end
      def to_hash
      end
      ...
      class Call < Zavudev::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Zavudev::Models::CallCreateResponse::Call,
        ...
        sig do
          returns(
            Zavudev::Models::CallCreateResponse::Call::Direction::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            Zavudev::Models::CallCreateResponse::Call::Status::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Zavudev::Models::CallCreateResponse::Call::Transcript]
            )
          )
        end
        ...
        sig do
          params(
            transcript:
              T::Array[
                Zavudev::Models::CallCreateResponse::Call::Transcript::OrHash
              ]
          ).void
        end
        ...
        sig do
          params(
            ...
            created_at: Time,
            direction:
              Zavudev::Models::CallCreateResponse::Call::Direction::OrSymbol,
            from: String,
            status: Zavudev::Models::CallCreateResponse::Call::Status::OrSymbol,
            to: String,
        ...
        module Direction
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Zavudev::Models::CallCreateResponse::Call::Direction
              )
            end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Zavudev::Models::CallCreateResponse::Call::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Transcript < Zavudev::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Zavudev::Models::CallCreateResponse::Call::Transcript,
                Zavudev::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              Zavudev::Models::CallCreateResponse::Call::Transcript::Role::TaggedSymbol
            )
          end
          attr_accessor :role
          ...
          sig do
            params(
              role:
                Zavudev::Models::CallCreateResponse::Call::Transcript::Role::OrSymbol,
              seq: Integer,
              text: String,
              ended_at: T.nilable(Time),
          ...
          module Role
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Zavudev::Models::CallCreateResponse::Call::Transcript::Role
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
