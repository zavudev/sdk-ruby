    ...
    module Functions
      class GitLinkRetrieveResponse < Zavudev::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Zavudev::Models::Functions::GitLinkRetrieveResponse,
        ...
        sig do
          returns(Zavudev::Models::Functions::GitLinkRetrieveResponse::Link)
        end
        attr_reader :link
        ...
        sig do
          params(
            link:
              Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::OrHash
          ).void
        end
        attr_writer :link
        ...
        class Link < Zavudev::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Zavudev::Models::Functions::GitLinkRetrieveResponse::Link,
                Zavudev::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::Connection::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::Provider::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::LastStatus::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              ...
              branch: String,
              connection:
                Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::Connection::OrSymbol,
              created_at: Time,
              function_id: String,
              owner: String,
              provider:
                Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::Provider::OrSymbol,
              repo: String,
              updated_at: Time,
              ...
              last_status:
                T.nilable(
                  Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::LastStatus::OrSymbol
                ),
          ...
          module Provider
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::Provider
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module LastStatus
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Zavudev::Models::Functions::GitLinkRetrieveResponse::Link::LastStatus
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
