    ...
    module Functions
      class TriggerListResponse < Zavudev::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Zavudev::Models::Functions::TriggerListResponse,
        ...
        sig do
          returns(
            T::Array[Zavudev::Models::Functions::TriggerListResponse::Trigger]
          )
        end
        ...
        sig do
          params(
            triggers:
              T::Array[
                Zavudev::Models::Functions::TriggerListResponse::Trigger::OrHash
              ]
          ).returns(T.attached_class)
        end
        def self.new(triggers:)
        end
