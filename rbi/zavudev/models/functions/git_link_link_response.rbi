    ...
    module Functions
      class GitLinkLinkResponse < Zavudev::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Zavudev::Models::Functions::GitLinkLinkResponse,
        ...
        sig { returns(Zavudev::Models::Functions::GitLinkLinkResponse::Link) }
        attr_reader :link

        sig do
          params(
            link: Zavudev::Models::Functions::GitLinkLinkResponse::Link::OrHash
          ).void
        end
        attr_writer :link
        ...
        class Link < Zavudev::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Zavudev::Models::Functions::GitLinkLinkResponse::Link,
                Zavudev::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              Zavudev::Models::Functions::GitLinkLinkResponse::Link::Connection::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              Zavudev::Models::Functions::GitLinkLinkResponse::Link::Provider::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                Zavudev::Models::Functions::GitLinkLinkResponse::Link::LastStatus::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              ...
              branch: String,
              connection:
                Zavudev::Models::Functions::GitLinkLinkResponse::Link::Connection::OrSymbol,
              created_at: Time,
              function_id: String,
              owner: String,
              provider:
                Zavudev::Models::Functions::GitLinkLinkResponse::Link::Provider::OrSymbol,
              repo: String,
              updated_at: Time,
              ...
              last_status:
                T.nilable(
                  Zavudev::Models::Functions::GitLinkLinkResponse::Link::LastStatus::OrSymbol
                ),
          ...
          module Connection
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Zavudev::Models::Functions::GitLinkLinkResponse::Link::Connection
                )
              end
          ...
          module Provider
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Zavudev::Models::Functions::GitLinkLinkResponse::Link::Provider
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module LastStatus
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Zavudev::Models::Functions::GitLinkLinkResponse::Link::LastStatus
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
