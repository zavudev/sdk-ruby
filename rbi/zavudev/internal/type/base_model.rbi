    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: Zavudev::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Zavudev::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  Zavudev::Internal::Type::BaseModel::KnownField,
                  { type: Zavudev::Internal::Type::Converter::Input }
                )
              ]
            )
          end
        ...
        class << self
          ...
          sig do
            params(
              model: Zavudev::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(Zavudev::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(Zavudev::Internal::AnyHash) }
        def to_h
        end
