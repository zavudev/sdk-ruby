      ...
      class PooledNetRequester
        ...
        class << self
          ...
          sig do
            params(
              request:
                Zavudev::Internal::Transport::PooledNetRequester::Request,
        ...
        sig do
          params(
            request: Zavudev::Internal::Transport::PooledNetRequester::Request
        ...
        def self.new(
          size: Zavudev::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS
        )
        end
      end
    end
