...
module Zavudev
  ...
  FunctionRollbackDeploymentParams =
    Zavudev::Models::FunctionRollbackDeploymentParams
  ...
  PhoneNumberSearchAvailableParams =
    Zavudev::Models::PhoneNumberSearchAvailableParams
  ...
  RegulatoryDocumentCreateParams =
    Zavudev::Models::RegulatoryDocumentCreateParams

  RegulatoryDocumentDeleteParams =
    Zavudev::Models::RegulatoryDocumentDeleteParams

  RegulatoryDocumentListParams = Zavudev::Models::RegulatoryDocumentListParams

  RegulatoryDocumentRetrieveParams =
    Zavudev::Models::RegulatoryDocumentRetrieveParams

  RegulatoryDocumentUploadURLParams =
    Zavudev::Models::RegulatoryDocumentUploadURLParams
  ...
  SenderRegenerateWebhookSecretParams =
    Zavudev::Models::SenderRegenerateWebhookSecretParams
  ...
  SenderUploadProfilePictureParams =
    Zavudev::Models::SenderUploadProfilePictureParams
  ...
  WhatsappBusinessProfileResponse =
    Zavudev::Models::WhatsappBusinessProfileResponse

  WhatsappBusinessProfileVertical =
    Zavudev::Models::WhatsappBusinessProfileVertical
